...
public class CustomizationRequest {
    ...
    @Valid
    @NotNull(message = "Pocket Types cannot be null")
    private PocketTypes pocketTypes;

    @Valid
    @NotNull(message = "Button Types cannot be null")
    ...
    @Valid
    private List<CustomizationAttribute> pantCuffsType;
    ...
    @Valid
        private List<FabricRequest> fabric;
}
