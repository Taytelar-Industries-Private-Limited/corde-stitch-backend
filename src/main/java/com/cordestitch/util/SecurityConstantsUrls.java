...
public class SecurityConstantsUrls {
    ...
    protected static final String[] CUSTOMER_LIST_URLS = {
            ...
            "/api/alteration/getOrderItems",
            "/api/alteration/getSlotTimes",
            "/api/alteration/bookSlotTimes",
            "/api/alteration/rescheduleOrCancelSlotTimes",
            "/api/alteration/getBookedSlotTimes",
            "/api/alteration/bookMeasurementSlot",
